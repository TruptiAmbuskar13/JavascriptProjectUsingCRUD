...
document.getElementById("form").reset();         //Data inserted then form is deleted and Reset...
...
// INSERT
    ...
    row.insertCell(3).innerHTML = `<button class="btn edit" onclick = edit(this)>Edit</button>
                                   <button class="btn delete" onclick = remove(this)>Delete</button>`; 
